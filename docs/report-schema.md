...
- ARX 2.0.0 preserved, and ARX 3.0.0rc1 continues to preserve, the legacy schema 0.1 envelope for `quick`, `deep`, `inspect`, `compare`, and bare `codex` workflows.
