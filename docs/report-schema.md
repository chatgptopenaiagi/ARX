...
- ARX 2.0.0, ARX 3.0.0rc1, and ARX 4.0.0b1 preserved, and ARX 4.0.0b2 continues to preserve, the legacy schema 0.1 envelope for `quick`, `deep`, `inspect`, `compare`, and bare `codex` workflows.
