...
- ARX 2.0.0, ARX 3.0.0rc1, ARX 4.0.0b1, and ARX 4.0.0b2 preserved, and ARX 4.0.0b3 continues to preserve, the legacy schema 0.1 envelope for `quick`, `deep`, `inspect`, `compare`, and bare `codex` workflows.
